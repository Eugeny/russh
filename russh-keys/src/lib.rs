...
";
    ...
    #[test]
    #[cfg(feature = "legacy-ed25519-pkcs8-parser")]
    fn test_decode_pkcs8_ed25519_generated_by_russh_0_43() -> Result<(), crate::Error> {
...
-----END ENCRYPTED PRIVATE KEY-----";
    ...
    impl futures::stream::Stream for Incoming<'_> {
        ...
        fn poll_next(
            ...
            if this.connections_left == 0 {
                return std::task::Poll::Ready(None);
            }
            let (sock, _addr) = futures::ready!(this.listener.poll_accept(cx))?;
            this.connections_left -= 1;
